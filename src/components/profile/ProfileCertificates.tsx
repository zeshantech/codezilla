    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Certificates earned by completing courses and challenges</CardDescription>
        </CardHeader>
        <CardContent>
          {certificates.length ? (
                ...
                <Card key={certificate.id} className="overflow-hidden pt-0">
                  ...
                  <CardContent className="pb-2">
                    <div className="flex items-center text-sm text-muted-foreground">
                      ...
                      <span>Earned: {dayjs(certificate.createdAt).format("DD MMM YYYY")}</span>
                      {certificate.expiresAt && (
                        <Badge variant="outline" className="ml-2">
                          Expires: {dayjs(certificate.expiresAt).format("DD MMM YYYY")}
                        </Badge>
                      )}
                    </div>
                  ...
                  <CardFooter>
                    <Button size="sm" className="ml-auto" href={certificate.credentialUrl} rel="noopener noreferrer">
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-md">Complete courses and challenges to earn certificates that showcase your skills</p>
